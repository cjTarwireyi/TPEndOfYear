<%@ Page Title="" Language="C#" MasterPageFile="~/site1/MasterPage.master" AutoEventWireup="true" CodeFile="Services.aspx.cs" Inherits="pages_Services" %>
...
<div id="sidebar-wrapper">
       <ul class="sidebar-nav nav-pills nav-stacked" id="menu">
           ...
           <li class="active"><a href="Services.aspx"><i class="glyphicon glyphicon-list "></i>&nbsp;Services</a></li>
