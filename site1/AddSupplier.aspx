<%@ Page Title="" Language="C#" MasterPageFile="~/site1/AccessMaster.master" AutoEventWireup="true" CodeFile="AddSupplier.aspx.cs" Inherits="site1_AddSupplier" %>
        ...
        <div class="form-group">
            <div class="input-group" id="Name">
                ...
                <asp:TextBox ID="txtName" runat="server" Height="35px" Width="290px"
                    class="form-control" placeholder="SupplierName"></asp:TextBox>
            </div>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                ErrorMessage="Supplier Surname Required!" ControlToValidate="txtSurname" ForeColor="Red"></asp:RequiredFieldValidator>
            <br />
        </div>
